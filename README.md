...
Find the API on RapidAPI (https://rapidapi.com)
Get the API Host - Look in the code examples for X-RapidAPI-Host
...
Your Chosen API
API Name: GeoDB Cities
API Host: wft-geo-db.p.rapidapi.com
Endpoints I'll use: /v1/geo/cities, /v1/geo/countries
Example:
...
1. What is going to be your list? (e.g., jokes from Dad Jokes API, weather forecasts from Weather API, movie results from IMDB API)

List of top 10 populated cities in a country

2. What is going to be your function with a parameter? (e.g., loadJokesByCategory with the parameter category, getWeatherByCity with the parameter cityName)

Describe how you are going to use the parameter in your code:

I will fetch the country code from the user input, then use it as the parameter to fetch the top 10 cities.

3. What is going to be your loop? (e.g., loop to display jokes, loop to display forecast days, loop to display movie results)
...
URL becomes: https://student-api-proxy.onrender.com/api/[API-HOST]/[ENDPOINT]
Add your API key in headers: 'X-API-Key': 'your-key'
Data is in result.data, cost info is in result.meta
Complete Examples
...
Use Bootstrap to design your HTML. Make sure it is visually appealing. Use dummy images and Lorem Ipsum if needed as placeholders.
...
External Resources
Bootstrap documentation, the gradient css website, MDN Web docs

Part V - Complete Google Doc
Complete Google Doc about your project: Google Doc Template

Make a copy, fill it out, and paste the link below:

(https://docs.google.com/document/d/1D_GAzXH_cprWNC3dUnCkbjSyDUh1qra7Hpq1u5X_9FU/edit?usp=sharing)
...
Need Help?
Check the available APIs first
Make sure your API key is correct
Check your budget hasn't run out
Ask me for help!
Happy coding! 🚀
